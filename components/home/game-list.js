  ...
  return (
    <div className="game-item flex gap-6 bg-base-100 px-4 py-3 rounded-xl">
      <Cover
        ...
        src={data.cover}
        alt={data.name} />
      <div className="grid sm:grid-cols-2 gap-y-1 gap-x-6 w-full">
...
export default function GameList ({ title = 'Games', data = [] }) {
  return (
    <div className="game-list grid gap-2 px-4 py-3 md:grid-cols-2">
      <h3 className="text-xl font-semibold md:col-span-2">{title}</h3>
