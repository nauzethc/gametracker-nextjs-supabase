...
import { getStatus, capitalize } from '../../utils/games'

export default function GameTracking ({ data = {}, className = '' }) {
  return (
    <div className={`flex flex-col p-6 text-lg gap-3 ${className}`}>
      ...
      <div className="flex items-center gap-4">
        ...
        <span className="overflow-ellipsis">{getStatus(data.status)}</span>
      </div>
      <div className="flex items-center gap-4">
